...
const Chat = ({ chatId }) => {
  ...
  useEffect(() => {
    ...
    // Listen to the chat messages in real-time
    ...
    const unsubscribe = onSnapshot(q, (querySnapshot) => {
      ...
      if (newMessages.length > 0) {
        ...
        if (lastMessage.sender !== storedUser.email && 'Notification' in window && Notification.permission === 'granted') {
